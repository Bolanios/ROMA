...
public class FiebreActivity extends AppCompatActivity {
    EditText editTextDesde,editTextHorario,editTextSintomas,editTextRiesgo,editTextFactor,editTextNotas;
    ImageView imageViewDesde,imageViewHorario,imageViewSintomas,imageViewRiesgo,imageViewFactor;
    Sounds sounds;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fiebre);
        prefsEstados= getSharedPreferences("EstadosROMA", MODE_PRIVATE);
        prefsDatos= getSharedPreferences("FiebreForm", MODE_PRIVATE);


        final Intent intent = new Intent(this, ListDialog.class);
        sounds=new Sounds();

        editTextDesde =findViewById(R.id.input_fiebre_desde);
        editTextHorario =findViewById(R.id.input_fiebre_horario);
        editTextSintomas =findViewById(R.id.input_fiebre_sintomas);
        editTextRiesgo = findViewById(R.id.input_fiebre_riesgo);
        editTextFactor = findViewById(R.id.input_fiebre_factor);
        editTextNotas = findViewById(R.id.notas);
        imageViewDesde =findViewById(R.id.sound_fiebre_desde);
        imageViewHorario =findViewById(R.id.sound_fiebre_horario);
        imageViewSintomas =findViewById(R.id.sound_fiebre_sintomas);
        imageViewRiesgo = findViewById(R.id.sound_fiebre_riesgo);
        imageViewFactor = findViewById(R.id.sound_fiebre_factor);
        ...
        imageViewRiesgo.setTag(getResources().getResourceEntryName(R.string.preg_f_riesgo_fiebre));
        imageViewFactor.setTag(getResources().getResourceEntryName(R.string.preg_factor_fiebre));
        ...
        editTextSintomas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("arrayNames", getResources().getResourceEntryName(R.array.fiebre_resp_sintomas));
                ...
                Log.e("refer",  getResources().getResourceEntryName(R.array.fiebre_resp_sintomas));

                intent.putExtra("arrayNames",   getResources().getResourceEntryName(R.array.fiebre_resp_sintomas));
                ...
                intent.putExtra("refer",        getResources().getResourceEntryName(R.array.fiebre_resp_sintomas));

                startActivityForResult(intent,3);
            }
        });
        editTextRiesgo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.e("arrayNames", getResources().getResourceEntryName(R.array.resp_si_no));
                Log.e("arrayFlags", getResources().getResourceEntryName(R.array.icon2));
                Log.e("title", getResources().getString(R.string.preg_f_riesgo_fiebre));
                ...
                intent.putExtra("arrayFlags",   getResources().getResourceEntryName(R.array.icon2));
                intent.putExtra("title",        getResources().getString(R.string.preg_f_riesgo_fiebre));
                intent.putExtra("refer",        getResources().getResourceEntryName(R.array.resp_si_no));

                startActivityForResult(intent,4);
            }
        });
        editTextFactor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.e("arrayNames", getResources().getResourceEntryName(R.array.fiebre_resp_exposiciones));
                Log.e("arrayFlags", getResources().getResourceEntryName(R.array.icon2));
                Log.e("title", getResources().getString(R.string.preg_factor_fiebre));
                Log.e("refer",  getResources().getResourceEntryName(R.array.fiebre_resp_exposiciones));

                intent.putExtra("arrayNames",   getResources().getResourceEntryName(R.array.fiebre_resp_exposiciones));
                intent.putExtra("arrayFlags",   getResources().getResourceEntryName(R.array.icon2));
                intent.putExtra("title",        getResources().getString(R.string.preg_factor_fiebre));
                intent.putExtra("refer",        getResources().getResourceEntryName(R.array.fiebre_resp_exposiciones));
        ...
        // Crear toolbar
        showToolbar(getResources().getString(R.string.fiebre),true);        //Getting the instance of Spinner and applying OnItemSelectedListener on it
    }
    ...
    public void onGuardar(View view) {
        ...
        editorLocal.putString("riesgo", editTextRiesgo.getText().toString());
        editorLocal.putString("factor", editTextFactor.getText().toString());
        editorLocal.putString("notas", editTextNotas.getText().toString());
        editorLocal.apply();

        editorEstados.putBoolean("FiebreForm",true);
    ...
    private void checarEstado() {
        if(prefsEstados.getBoolean("FiebreForm",false)){
            ...
            editTextRiesgo.setText(prefsDatos.getString("riesgo",""));
            editTextFactor.setText(prefsDatos.getString("factor",""));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 4) {
            ...
            if (resultCode == Activity.RESULT_CANCELED) {
                Log.e("resultCANCELED",String.valueOf(ListDialog.getArraySelectList()) );
                editTextRiesgo.setText(String.valueOf(ListDialog.getStringSelectList()));
            }
        }
        if (requestCode == 5) {
            if(resultCode == Activity.RESULT_OK){
            ...
            if (resultCode == Activity.RESULT_CANCELED) {
                Log.e("resultCANCELED",String.valueOf(ListDialog.getArraySelectList()) );
                editTextFactor.setText(String.valueOf(ListDialog.getStringSelectList()));
            }
        }
