...
public class CuelloActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuello);
        prefsEstados= getSharedPreferences("EstadosROMA", MODE_PRIVATE);
        prefsDatos= getSharedPreferences("CuelloForm", MODE_PRIVATE);

        final Intent intent = new Intent(this, ListDialog.class);
        sounds=new Sounds();

        editTextDesde =findViewById(R.id.input_cuello_desde);
        editTextHorario =findViewById(R.id.input_cuello_horario);
        editTextSintomas =findViewById(R.id.input_cuello_sintomas);
        imageViewDesde =findViewById(R.id.sound_cuello_desde);
        imageViewhorario =findViewById(R.id.sound_cuello_horario);
        imageViewSintomas =findViewById(R.id.sound_cuello_sintomas);
        ...
        editTextSintomas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("arrayNames", getResources().getResourceEntryName(R.array.cuello_resp_motivos));
                Log.e("arrayFlags", getResources().getResourceEntryName(R.array.icon3));
                Log.e("title", getResources().getString(R.string.preg_g3_sintomas));
                Log.e("refer",  getResources().getResourceEntryName(R.array.cuello_resp_motivos));


                intent.putExtra("arrayNames",   getResources().getResourceEntryName(R.array.cuello_resp_motivos));
                intent.putExtra("arrayFlags",   getResources().getResourceEntryName(R.array.icon3));
                intent.putExtra("title",        getResources().getString(R.string.preg_g3_sintomas));
                intent.putExtra("refer",        getResources().getResourceEntryName(R.array.cuello_resp_motivos));
        ...
        // Crear toolbar
        showToolbar(getResources().getString(R.string.cuello),true);        //Getting the instance of Spinner and applying OnItemSelectedListener on it
    }
    ...
    public void onGuardar(View view) {
        ...
        editorEstados.putBoolean("CuelloForm",true);
