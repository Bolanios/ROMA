...
public class ToraxActivity extends AppCompatActivity {
    EditText editTextDesde,editTextHorario,editTextSintomas,editTextNotas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefsDatos= getSharedPreferences("ToraxForm", MODE_PRIVATE);

        final Intent intent = new Intent(this, ListDialog.class);
        sounds=new Sounds();

        editTextDesde =findViewById(R.id.input_torax_desde);
        editTextHorario =findViewById(R.id.input_torax_horario);
        editTextSintomas =findViewById(R.id.input_torax_sintomas);
        imageViewDesde =findViewById(R.id.sound_torax_desde);
        imageViewhorario =findViewById(R.id.sound_torax_horario);
        imageViewSintomas =findViewById(R.id.sound_torax_sintomas);
        ...
        editTextSintomas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("arrayNames", getResources().getResourceEntryName(R.array.torax_resp_sintomas));
                Log.e("arrayFlags", getResources().getResourceEntryName(R.array.icon7));
                Log.e("title", getResources().getString(R.string.preg_g3_sintomas));
                Log.e("refer",  getResources().getResourceEntryName(R.array.torax_resp_sintomas));


                intent.putExtra("arrayNames",   getResources().getResourceEntryName(R.array.torax_resp_sintomas));
                intent.putExtra("arrayFlags",   getResources().getResourceEntryName(R.array.icon7));
                intent.putExtra("title",        getResources().getString(R.string.preg_g3_sintomas));
                intent.putExtra("refer",        getResources().getResourceEntryName(R.array.torax_resp_sintomas));
        ...
        // Crear toolbar
        showToolbar(getResources().getString(R.string.torax),true);        //Getting the instance of Spinner and applying OnItemSelectedListener on it
    }
    ...
    public void onGuardar(View view) {
        ...
        editorEstados.putBoolean("ToraxForm",true);
