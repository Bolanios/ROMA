...
public class CabezaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefsDatos= getSharedPreferences("CabezaForm", MODE_PRIVATE);

        final Intent intent = new Intent(this, ListDialog.class);
        sounds=new Sounds();

        editTextDesde =findViewById(R.id.input_cabeza_desde);
        editTextHorario =findViewById(R.id.input_cabeza_horario);
        editTextSintomas =findViewById(R.id.input_cabeza_sintomas);
        imageViewDesde =findViewById(R.id.sound_cabeza_desde);
        imageViewHorario =findViewById(R.id.sound_cabeza_horario);
        imageViewSintomas =findViewById(R.id.sound_cabeza_sintomas);
        ...
        editTextSintomas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("arrayNames", getResources().getResourceEntryName(R.array.cabeza_resp_sintomas));
                ...
                Log.e("refer",  getResources().getResourceEntryName(R.array.cabeza_resp_sintomas));


                intent.putExtra("arrayNames",   getResources().getResourceEntryName(R.array.cabeza_resp_sintomas));
                ...
                intent.putExtra("refer",        getResources().getResourceEntryName(R.array.cabeza_resp_sintomas));
        ...
        // Crear toolbar
        showToolbar(getResources().getString(R.string.cabeza),true);        //Getting the instance of Spinner and applying OnItemSelectedListener on it
    }
    ...
    public void onGuardar(View view) {
        ...
        editorEstados.putBoolean("CabezaForm",true);
