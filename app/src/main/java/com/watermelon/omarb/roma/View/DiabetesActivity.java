...
public class DiabetesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefsDatos= getSharedPreferences("DiabetesForm", MODE_PRIVATE);

        final Intent intent = new Intent(this, ListDialog.class);
        sounds=new Sounds();

        editTextFamiliares =findViewById(R.id.input_diabetes_familiares);
        editTextUsted =findViewById(R.id.input_diabetes_usted);
        editTextAlimentacion =findViewById(R.id.input_diabetes_alimentos);
        editTextCuando = findViewById(R.id.input_diabetes_desde);
        editTextTratamiento = findViewById(R.id.input_diabetes_tratamiento);
        editTextNotas =findViewById(R.id.notas);
        imageViewFamiliares =findViewById(R.id.sound_diabetes_familiares);
        imageViewUsted =findViewById(R.id.sound_diabetes_usted);
        imageViewAlimentacion =findViewById(R.id.sound_diabetes_alimentos);
        imageViewCuando = findViewById(R.id.sound_diabetes_desde);
        imageViewTratamiento = findViewById(R.id.sound_diabetes_tratamiento);
        imageViewFamiliares.setTag(getResources().getResourceEntryName(R.string.diabetes_preg_fam));
        imageViewUsted.setTag(getResources().getResourceEntryName(R.string.diabetes_preg_diag));
        imageViewAlimentacion.setTag(getResources().getResourceEntryName(R.string.diabetes_preg_alimentacion));
        imageViewCuando.setTag(getResources().getResourceEntryName(R.string.diabetes_preg_desde));
        imageViewTratamiento.setTag(getResources().getResourceEntryName(R.string.diabetes_preg_tratamiento));
        ...
        editTextFamiliares.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("title",        getResources().getString(R.string.diabetes_preg_fam));
        ...
        editTextUsted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("arrayNames", getResources().getResourceEntryName(R.array.resp_si_no));
                Log.e("arrayFlags", getResources().getResourceEntryName(R.array.icon2));
                Log.e("title", getResources().getString(R.string.diabetes_preg_diag));
                Log.e("refer",  getResources().getResourceEntryName(R.array.resp_si_no));
                intent.putExtra("arrayNames",   getResources().getResourceEntryName(R.array.resp_si_no));
                intent.putExtra("arrayFlags",   getResources().getResourceEntryName(R.array.icon2));
                intent.putExtra("title",        getResources().getString(R.string.diabetes_preg_diag));
                intent.putExtra("refer",        getResources().getResourceEntryName(R.array.resp_si_no));
        ...
        editTextCuando.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog  mdiDialog =new DatePickerDialog(DiabetesActivity.this,new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        // Crear toolbar
        showToolbar(getResources().getString(R.string.diabetes),true);        //Getting the instance of Spinner and applying OnItemSelectedListener on it
    }
    ...
    public void onGuardar(View view) {
        ...
        editorEstados.putBoolean("DiabetesForm",true);
